        ...
        <header className="p-4 bg-gray-500 text-white">
            <div className="container flex justify-between h-16 mx-auto">
                ...
                <div className="items-center flex-shrink-0 hidden lg:flex">
                    ...
                    <button onClick={() => navigate("/signup")} className={`self-center px-8 py-3 rounded ${pathname == "/signup" ? "text-red-500" : ""}`}>Sign up</button>
                    {
                        user?.email ? <button onClick={handleLogOut} className={`self-center px-8 py-3 rounded cursor-pointer hover:underline`}>Log Out</button> : ""
                    }
